...
<div class="container">
	<div class="row z-depth-1 padding-2vw border-top white">
					...
					<div class="card hoverable"> <!-- small, medium, large -->
						...
						<div class="card-reveal">
							<div class="row">
								...
								<span class="right orange-text"><i class="fa fa-star"></i> <?php echo $rating ?></span>
							</div>
				...
				<div id="rate<?php echo $cek ?>" class="modal bottom-sheet">
					<div class="modal-content">
						...
						<div class=" center-align">
							...
							<form method="post" action="<?php echo base_url() ?>novel/rate">
								<div class="row">
									<div class="col s12 m8 offset-m2">
										...
										<input name="id_novel" type="text" value="<?php echo $id_novel?>" hidden>
		...
		<h1 class="flow-text center-align">tidak ada novel yang tersedia</h1>
		<div class="center-align">
			<a class="btn waves-effect waves-light orange" href="<?php echo base_url() ?>home/form_request">Request novel ini
